...
class MusicCog(commands.Cog):
    def __init__(self, bot):
        ...
        self.ffmpeg_options = {
            ...
            'executable': r'C:\Users\ttbri\AppData\Local\Microsoft\WinGet\Packages\Gyan.FFmpeg_Microsoft.Winget.Source_8wekyb3d8bbwe\ffmpeg-9.0-full_build\bin\ffmpeg.exe'
        }
